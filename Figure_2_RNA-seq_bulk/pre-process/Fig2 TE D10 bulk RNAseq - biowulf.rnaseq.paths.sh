...
# copy the first part to rnaseq.paths.sh
# sourcing the first from a separate file is not practical
# it messes up paths downstream
...
# software versions
BBTV="38.84" # BBTools, not used, just for reference
SUBRV="2.0.0" # Subread version
